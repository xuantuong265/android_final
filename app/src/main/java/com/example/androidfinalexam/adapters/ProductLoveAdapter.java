...
import com.example.androidfinalexam.viewholders.ProductLoveHolder;
import com.squareup.picasso.Picasso;

import java.text.DecimalFormat;
import java.util.ArrayList;

public class ProductLoveAdapter extends RecyclerView.Adapter<ProductLoveHolder> {

    private Context context;
    private ArrayList<Products> mData;

    public ProductLoveAdapter(Context context, ArrayList<Products> mData) {
    ...
    @NonNull
    @Override
    public ProductLoveHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_layout_products_brand, parent, false);
        return new ProductLoveHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProductLoveHolder holder, final int position) {
